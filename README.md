...
El objetivo de v3.2 es que el estudiante pueda pasar de la definición conceptual a la inspección de los campos reales: **nombre del campo → bits → bytes → valor de ejemplo → función → quién lo agrega → quién lo procesa**.
